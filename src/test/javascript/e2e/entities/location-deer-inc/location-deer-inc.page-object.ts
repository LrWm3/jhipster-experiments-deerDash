...
export class LocationComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-location-deer-inc div table .btn-danger'));
  title = element.all(by.css('jhi-location-deer-inc div h2#page-heading span')).first();
...
export class LocationUpdatePage {
  pageTitle = element(by.id('jhi-location-deer-inc-heading'));
