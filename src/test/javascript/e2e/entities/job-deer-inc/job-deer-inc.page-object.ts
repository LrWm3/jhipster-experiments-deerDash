...
export class JobComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-job-deer-inc div table .btn-danger'));
  title = element.all(by.css('jhi-job-deer-inc div h2#page-heading span')).first();
...
export class JobUpdatePage {
  pageTitle = element(by.id('jhi-job-deer-inc-heading'));
