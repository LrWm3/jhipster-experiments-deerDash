...
import { EmployeeComponentsPage, EmployeeDeleteDialog, EmployeeUpdatePage } from './employee-deer-inc.page-object';
...
describe('Employee e2e test', () => {
  ...
  it('should load Employees', async () => {
    await navBarPage.goToEntity('employee-deer-inc');
    employeeComponentsPage = new EmployeeComponentsPage();
    await browser.wait(ec.visibilityOf(employeeComponentsPage.title), 5000);
    expect(await employeeComponentsPage.getTitle()).to.eq('deerDashApp.employee.home.title');
  ...
  it('should load create Employee page', async () => {
    ...
    expect(await employeeUpdatePage.getPageTitle()).to.eq('deerDashApp.employee.home.createOrEditLabel');
  ...
  it('should delete last Employee', async () => {
    ...
    expect(await employeeDeleteDialog.getDialogTitle()).to.eq('deerDashApp.employee.delete.question');
