...
export class EmployeeComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-employee-deer-inc div table .btn-danger'));
  title = element.all(by.css('jhi-employee-deer-inc div h2#page-heading span')).first();
...
export class EmployeeUpdatePage {
  pageTitle = element(by.id('jhi-employee-deer-inc-heading'));
