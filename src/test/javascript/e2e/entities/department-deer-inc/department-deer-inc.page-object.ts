...
export class DepartmentComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-department-deer-inc div table .btn-danger'));
  title = element.all(by.css('jhi-department-deer-inc div h2#page-heading span')).first();
...
export class DepartmentUpdatePage {
  pageTitle = element(by.id('jhi-department-deer-inc-heading'));
