...
import { DepartmentComponentsPage, DepartmentDeleteDialog, DepartmentUpdatePage } from './department-deer-inc.page-object';
...
describe('Department e2e test', () => {
  ...
  it('should load Departments', async () => {
    await navBarPage.goToEntity('department-deer-inc');
    ...
    expect(await departmentComponentsPage.getTitle()).to.eq('deerDashApp.department.home.title');
  ...
  it('should load create Department page', async () => {
    ...
    expect(await departmentUpdatePage.getPageTitle()).to.eq('deerDashApp.department.home.createOrEditLabel');
  ...
  it('should delete last Department', async () => {
    ...
    expect(await departmentDeleteDialog.getDialogTitle()).to.eq('deerDashApp.department.delete.question');
