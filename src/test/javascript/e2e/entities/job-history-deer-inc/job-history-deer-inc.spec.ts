...
import { JobHistoryComponentsPage, JobHistoryDeleteDialog, JobHistoryUpdatePage } from './job-history-deer-inc.page-object';
...
describe('JobHistory e2e test', () => {
  ...
  it('should load JobHistories', async () => {
    await navBarPage.goToEntity('job-history-deer-inc');
    ...
    expect(await jobHistoryComponentsPage.getTitle()).to.eq('deerDashApp.jobHistory.home.title');
  ...
  it('should load create JobHistory page', async () => {
    ...
    expect(await jobHistoryUpdatePage.getPageTitle()).to.eq('deerDashApp.jobHistory.home.createOrEditLabel');
  ...
  it('should delete last JobHistory', async () => {
    ...
    expect(await jobHistoryDeleteDialog.getDialogTitle()).to.eq('deerDashApp.jobHistory.delete.question');
