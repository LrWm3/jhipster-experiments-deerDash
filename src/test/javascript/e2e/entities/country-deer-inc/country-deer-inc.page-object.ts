...
export class CountryComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-country-deer-inc div table .btn-danger'));
  title = element.all(by.css('jhi-country-deer-inc div h2#page-heading span')).first();
...
export class CountryUpdatePage {
  pageTitle = element(by.id('jhi-country-deer-inc-heading'));
