...
export class RegionComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-region-deer-inc div table .btn-danger'));
  title = element.all(by.css('jhi-region-deer-inc div h2#page-heading span')).first();
...
export class RegionUpdatePage {
  pageTitle = element(by.id('jhi-region-deer-inc-heading'));
