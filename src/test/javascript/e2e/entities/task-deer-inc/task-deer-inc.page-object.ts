...
export class TaskComponentsPage {
  ...
  deleteButtons = element.all(by.css('jhi-task-deer-inc div table .btn-danger'));
  title = element.all(by.css('jhi-task-deer-inc div h2#page-heading span')).first();
...
export class TaskUpdatePage {
  pageTitle = element(by.id('jhi-task-deer-inc-heading'));
