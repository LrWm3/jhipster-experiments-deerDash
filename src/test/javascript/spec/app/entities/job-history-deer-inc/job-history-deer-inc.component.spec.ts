...
import { JobHistoryDeerIncComponent } from 'app/entities/job-history-deer-inc/job-history-deer-inc.component';
...
describe('Component Tests', () => {
  describe('JobHistoryDeerInc Management Component', () => {
    let comp: JobHistoryDeerIncComponent;
    let fixture: ComponentFixture<JobHistoryDeerIncComponent>;
    let service: JobHistoryDeerIncService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [DeerDashTestModule],
        declarations: [JobHistoryDeerIncComponent],
        providers: [
          {
        ...
        .overrideTemplate(JobHistoryDeerIncComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(JobHistoryDeerIncComponent);
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new JobHistoryDeerInc(123)],
            headers
          })
        )
      );
