...
import { JobDeerIncComponent } from 'app/entities/job-deer-inc/job-deer-inc.component';
...
describe('Component Tests', () => {
  describe('JobDeerInc Management Component', () => {
    let comp: JobDeerIncComponent;
    let fixture: ComponentFixture<JobDeerIncComponent>;
    let service: JobDeerIncService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [DeerDashTestModule],
        declarations: [JobDeerIncComponent],
        providers: [
          {
        ...
        .overrideTemplate(JobDeerIncComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(JobDeerIncComponent);
