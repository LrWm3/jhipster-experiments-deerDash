...
import { EmployeeDeerIncComponent } from 'app/entities/employee-deer-inc/employee-deer-inc.component';
...
describe('Component Tests', () => {
  describe('EmployeeDeerInc Management Component', () => {
    let comp: EmployeeDeerIncComponent;
    let fixture: ComponentFixture<EmployeeDeerIncComponent>;
    let service: EmployeeDeerIncService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [DeerDashTestModule],
        declarations: [EmployeeDeerIncComponent],
        providers: [
          {
        ...
        .overrideTemplate(EmployeeDeerIncComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(EmployeeDeerIncComponent);
