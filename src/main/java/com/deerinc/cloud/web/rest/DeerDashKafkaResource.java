...
@RestController
@RequestMapping("/api/deer-dash-kafka")
public class DeerDashKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DeerDashKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DeerDashKafkaResource(KafkaProperties kafkaProperties) {
